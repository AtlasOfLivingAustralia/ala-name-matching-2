  ...
  public double infer_t(SimpleLinnaeanInferencer.Evidence evidence, SimpleLinnaeanParameters_TT parameters, Trace trace) {
    ...
    if (evidence.isT$e$genus()) {
      ...
      if (trace != null) {
        ...
        trace.add(TraceLevel.TRACE, "p(genus) - genus", "p(genus | taxonID, soundexScientificName, scientificName)·taxonID·soundexScientificName·scientificName + p(genus | taxonID, soundexScientificName, ¬scientificName)·taxonID·soundexScientificName·¬scientificName + p(genus | taxonID, ¬soundexScientificName, scientificName)·taxonID·¬soundexScientificName·scientificName + p(genus | taxonID, ¬soundexScientificName, ¬scientificName)·taxonID·¬soundexScientificName·¬scientificName", val_, c$genus);
      }
    }
    if (evidence.isF$e$genus()) {
      ...
      if (trace != null) {
        ...
        trace.add(TraceLevel.TRACE, "p(¬genus) - !genus", "p(¬genus | taxonID, soundexScientificName, scientificName)·taxonID·soundexScientificName·scientificName + p(¬genus | taxonID, soundexScientificName, ¬scientificName)·taxonID·soundexScientificName·¬scientificName + p(¬genus | taxonID, ¬soundexScientificName, scientificName)·taxonID·¬soundexScientificName·scientificName + p(¬genus | taxonID, ¬soundexScientificName, ¬scientificName)·taxonID·¬soundexScientificName·¬scientificName", val_, nc$genus);
      }
    }
