...
public class LuceneParameterAnalyserTest {
    ...
    public void testComputePrior1() throws Exception {
        LuceneParameterAnalyser analyser = new LuceneParameterAnalyser(this.network, this.annotator, this.lucene.getSearcher(), this.weight, DEFAULT_WIEGHT);
        assertEquals(0.28, analyser.computePrior(this.makeFact(DwcTerm.genus, "Osphranter")), Inference.MINIMUM_PROBABILITY);
    }

    @Test
    public void testComputePrior2() throws Exception {
        LuceneParameterAnalyser analyser = new LuceneParameterAnalyser(this.network, this.annotator, this.lucene.getSearcher(), this.weight, DEFAULT_WIEGHT);
        assertEquals(0.48, analyser.computePrior(this.makeFact(DwcTerm.genus, "Acacia")), Inference.MINIMUM_PROBABILITY);
    }
    ...
    public void testComputePrior3() throws Exception {
        ...
        assertEquals(Inference.MAXIMUM_PROBABILITY, analyser.computePrior(this.makeFact(DwcTerm.genus, "Montitega", "Acacia", "Osphranter", "Agathis")), Inference.MINIMUM_PROBABILITY);
    }
    ...
    public void testComputePrior4() throws Exception {
        ...
        assertEquals(Inference.MINIMUM_PROBABILITY, analyser.computePrior(this.makeFact(DwcTerm.genus, "Invalid")), Inference.MINIMUM_PROBABILITY);
    }
