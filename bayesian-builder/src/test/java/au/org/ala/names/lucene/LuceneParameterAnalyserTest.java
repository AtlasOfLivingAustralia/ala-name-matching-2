...
public class LuceneParameterAnalyserTest {
    ...
    public void testTotalWeight1() throws Exception {
        LuceneParameterAnalyser analyser = new LuceneParameterAnalyser(this.network, this.lucene.getSearcher(), this.weight, DEFAULT_WIEGHT, this.network.getInputs(), this.network.getOutputs(), false);
