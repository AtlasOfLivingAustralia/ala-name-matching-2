 ...
 * </p>
 */
public class CopyDerivation extends CompiledDerivation {
    ...
    public Class<?> getValueClass() {
        return this.sources.get(0).getType();
    }

    /**
     * Generate code to get values from the source.
     * <p>
     * Only use the first source.
     * </p>
    ...
    public String generateValue(String documentVar, String observablesClass) {
        ...
        builder.append(observablesClass + "." + this.sources.get(0).getJavaVariable());
        builder.append(")");
        return builder.toString();
    }

    /**
     * Generate code to get variant values from the source,
     *
     * @param documentVar The name of the document variable (a lucene document)
     * @return The code to get the values
     */
