...
public class NetworkGeneratorMojoTest {
    ...
    public void testGenerate1() throws Exception {
        ...
        File inference_ = new File(base, "Network1Inferencer_.java");
        assertTrue(inference.exists());
        File parameters = new File(base, "Network1Parameters_.java");
        assertTrue(parameters.exists());
        File builder = new File(base, "Network1Builder.java");
        assertTrue(builder.exists());
        File builder_ = new File(base, "Network1Builder_.java");
        assertTrue(builder_.exists());
    ...
    public void testGenerate2() throws Exception {
        ...
        File inference_ = new File(base, "Network1Inference_.java");
        assertFalse(inference_.exists());
        File parameters = new File(base, "Network1Parameters_.java");
