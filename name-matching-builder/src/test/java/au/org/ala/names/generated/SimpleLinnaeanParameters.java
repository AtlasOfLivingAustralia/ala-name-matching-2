...
public class SimpleLinnaeanParameters extends Parameters {
  ...
  public SimpleLinnaeanParameters() {
  }
  ...
  public void build() {
    ...
    this.inf_f_f$specificEpithet = 1.0 - inf_t_f$specificEpithet;
    this.inf_f_t$scientificNameAuthorship = 1.0 - inf_t_t$scientificNameAuthorship;
    this.inf_f_f$scientificNameAuthorship = 1.0 - inf_t_f$scientificNameAuthorship;
    this.inf_f_tt$scientificName = 1.0 - inf_t_tt$scientificName;
    this.inf_f_tf$scientificName = 1.0 - inf_t_tf$scientificName;
    this.inf_f_ft$scientificName = 1.0 - inf_t_ft$scientificName;
    this.inf_f_ff$scientificName = 1.0 - inf_t_ff$scientificName;
    this.derived_t_tt$scientificName = inf_t_tt$scientificName * inf_t_t$specificEpithet;
    this.derived_f_tt$scientificName = inf_f_tt$scientificName * inf_t_t$specificEpithet;
    this.derived_t_tf$scientificName = inf_t_ft$scientificName * inf_t_f$specificEpithet;
    this.derived_f_tf$scientificName = inf_f_ft$scientificName * inf_t_f$specificEpithet;
    this.derived_t_ft$scientificName = inf_t_tf$scientificName * inf_f_t$specificEpithet;
    this.derived_f_ft$scientificName = inf_f_tf$scientificName * inf_f_t$specificEpithet;
    this.derived_t_ff$scientificName = inf_t_ff$scientificName * inf_f_f$specificEpithet;
    this.derived_f_ff$scientificName = inf_f_ff$scientificName * inf_f_f$specificEpithet;
    this.inf_f_t$soundexScientificName = 1.0 - inf_t_t$soundexScientificName;
    this.inf_f_f$soundexScientificName = 1.0 - inf_t_f$soundexScientificName;
    this.inf_f_tt$genus = 1.0 - inf_t_tt$genus;
    this.inf_f_tf$genus = 1.0 - inf_t_tf$genus;
    this.inf_f_ft$genus = 1.0 - inf_t_ft$genus;
    this.inf_f_ff$genus = 1.0 - inf_t_ff$genus;
    this.derived_t_tt$genus = inf_t_tt$genus * inf_t_t$soundexScientificName;
    this.derived_f_tt$genus = inf_f_tt$genus * inf_t_t$soundexScientificName;
    this.derived_t_tf$genus = inf_t_ft$genus * inf_t_f$soundexScientificName;
    this.derived_f_tf$genus = inf_f_ft$genus * inf_t_f$soundexScientificName;
    this.derived_t_ft$genus = inf_t_tf$genus * inf_f_t$soundexScientificName;
    this.derived_f_ft$genus = inf_f_tf$genus * inf_f_t$soundexScientificName;
    this.derived_t_ff$genus = inf_t_ff$genus * inf_f_f$soundexScientificName;
    this.derived_f_ff$genus = inf_f_ff$genus * inf_f_f$soundexScientificName;
    this.inf_f_t$family = 1.0 - inf_t_t$family;
    ...
    this.inf_f_f$kingdom = 1.0 - inf_t_f$kingdom;
  }
